        ...
        <table class="table table-hover" table-layout="fixed"  white-space="nowrap">
            ...
            <?php foreach($grupo as $item) { ?>
                <tr>
                    ...
                    <td><input class="form-control" type="input" name="gruid" readonly value=<?php echo $item->gruid;?>></td>
                </tr>
                <tr>
                    <td class="col-xs-5">Descripcion</td>
                    <td><input class="form-control" type="input" name="grudsc" value="<?php echo $item->grudsc;?>"></td>
                </tr>
                <tr>
                    <td class="col-xs-5">Template</td>
                    <td><input class="form-control" type="input" name="grutem" value="<?php echo $item->grutem;?>"></td>
                </tr>
            <?php } ?>
            <tr>
