        ...
        <div class="form-group">
            <div class="col-sm-10">
                <table class="table table-hover" width="50%" table-layout="fixed" white-space="nowrap">
                    ...
                    <th class="col-xs-5" nowrap="true">Tipo de Empresa</th>                                     
                    <th class="col-xs-2"> <a href=<?php echo base_url().'tipoCliente/new_tipocliente/';?>>
                    ...
                    <tr>
                        <td class="col-xs-2"><a href=<?php echo base_url().'tipoCliente/update/'.$tipocliente->tipid;?>>
...
<!--                         <td class="col-xs-2"><a href=<?php //echo base_url().'tipoCliente/update/'.$tipocliente->tipid;?>>
                        ...
                        <td class="col-xs-5" nowrap="true"><?php echo trim($tipocliente->tipdsc); ?></td>                        
                        <td class="col-xs-5"><a href=<?php echo base_url().'tipoCliente/borrar/'.$tipocliente->tipid;?>>
...
<script>
    ...
    Swal.fire({
        ...
        $.ajax({
            type:"DELETE",
            url: "<?php echo base_url().'tipoCliente/delete/'.$this->session->flashdata('delete');?>",
            success:function(datos){                                
                ...
                window.location = "<?php echo base_url().'tipoCliente/index/'.$_SESSION['current_page'];?>"; 
            },
            error: function() {
                var jsonData = JSON.parse(datos);
                Swal.fire({
