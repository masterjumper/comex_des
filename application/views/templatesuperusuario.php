...
<div id="wrapper">
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo base_url().'Login/inicio'?>">Comex OnLine</a>
        </div>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url().'Negocio/index'?>"><i class="fa fa-tasks"></i> Ventas</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url().'Cliente/index'?>"><i class="fa fa-users"></i> Usuarios</a>
                        <!--<a href="<?php //echo base_url().'index.php?/Cliente/index'?>"><i class="fa fa-users"></i> Clientes</a>-->
                    </li>                    
                    <li>
                        <a href="<?php echo base_url().'Empresa/index'?>"><i class="fa fa-industry"></i> Empresas</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url().'tipoCliente/index'?>"><i class="fa fa-tag"></i> Tipos de Empresas</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url().'MaterialEmbalaje/index'?>"><i class="fa fa-dropbox"></i> Material de Embalaje</a>
                    </li>
<!--                     <li>
                        <a href="<?php //echo base_url().'Claim/index'?>"><i class="fa fa-exclamation-circle"></i> Claims</a>
                    </li> -->
                    <li>
                    <a href="#"><i class="fa fa-user-secret"></i> Seguridad<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo base_url().'Grupo/index'?>"><i class="fa fa-folder"></i> Grupos de Usuarios</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url().'Usuario/index'?>"><i class="fa fa-user"></i> Usuarios</a>
                            </li>                            
                            <li>
                                <a href="<?php echo base_url().'Encuesta/index'?>"><i class="fa fa-user"></i> Encuesta</a>
                            </li>                            
                        </ul>
                    </li>
                </ul>
